...
Dieser arbeitet auf der Eingabe einer Kette $(V,E)$ sowie einer Menge $A$ von Pfaden in $(V,E)$ in gieriger Ordnung sortiert. \todo{check sorting (p.229)}
...
gilt $A \leq_G B$.
\begin{lemma}[Optimalität des gierigen Algorithmus']\label{lem:optimalityGreedyAlgorithm}
