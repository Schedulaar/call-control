...
\begin{proof}
    ...
    Also besitzen alle $C$ Farben einen Pfad, der $e$ enthält, insgesamt gibt es also $C+1$ Pfade in $A \cap \{p\}$, die
    $e$ enthalten. Das ist allerdings ein Widerspruch dazu, dass $A \cap \{p\}$ eine geeignete Menge ist.
\end{proof}
