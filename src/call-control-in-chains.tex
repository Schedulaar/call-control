...
gilt $A \leq_G B$.
\begin{lemma}[Optimalität des gierigen Algorithmus']\label{lem:greedyAlgorithm}
...
Algorithmus nach Lemma~\ref{lem:greedyAlgorithm} eine gleichmächtige, sogar minimale Lösung.
...
\begin{theorem}
    ...
    $O(n+m)$, wobei $n$ die Anzahl der Knoten und $m$ die Anzahl der gegebenen Pfade ist.
\end{theorem}
