...
Genauer berechnet der Algorithmus zunächst zu jedem Pfad $p \in P$ den {\em bevorzugten Anführer von $p$}, also den
größten Pfad in P, dessen Endknoten kleinergleich dem Anfangsknoten von $p$ ist.
