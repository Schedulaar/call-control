...
\begin{proof}
    ...
    Dadurch ist auch $G$ geeignet und durch die Transitivität von $\leq_G$ auf Mengen von Pfaden folgt $G \leq_G Q_0$,
...
\begin{figure}[htbp]
	...
	\caption{Eine Färbung mit $C=2$, wobei schwarz und grau eine Farbe darstellen, schwarz umrandete Pfade stehen für verworfene Pfade. (mod. nach~\cite{paper})}
...
Dazu wird zuerst eine Liste $L$ der Endknoten aller Pfade, jetzt mit Platzhalterpfaden, angelegt, die die Knoten
