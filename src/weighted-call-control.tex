...
Wir wollen uns dagegen wieder dem Problem mit willkürlichen Kapazitäten widmen.
...
\begin{proof}
    ...
    aller Kanten $e$ durch Platzhalterpfade aufgefüllt werden und erhalten wir eine optimale Lösung, in der alle
    Platzhalterpfade akzeptiert wurden, so ist die Menge der akzeptierten Originalpfade eine optimale Lösung für
